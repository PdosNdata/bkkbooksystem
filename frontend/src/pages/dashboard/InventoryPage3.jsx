...
export default function InventoryPage3() {
  ...
  // Helper function to get stock info - รวมจากทุก grade และ academic_year
  const getStockInfo = (item) => {
    if (!item.book_stock || !Array.isArray(item.book_stock)) {
      return {
        available: 0,
        min: 5
      }
    ...
    // รวม available_quantity จากทุก record
    const totalAvailable = item.book_stock.reduce((sum, stock) => {
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            onClick={exportPdf}
            className="flex items-center gap-2 px-4 py-2.5 border border-red-300 dark:border-red-800 text-red-600 rounded-xl text-sm hover:bg-red-50 dark:hover:bg-red-900/30"
          >
                  ...
                  <tr key={item.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td className="px-4 py-3 text-center">
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                        isLow ? 'bg-red-100 text-red-700 dark:bg-red-900/50 dark:text-red-300' : 'bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-300'
                      }`}>
                        {available}
                      </span>
                    </td>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-lg p-6 mx-4">
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  type="text"
                  className="input-field mt-1 dark:bg-gray-700 dark:text-white dark:border-gray-600"
                  value={form.title}
