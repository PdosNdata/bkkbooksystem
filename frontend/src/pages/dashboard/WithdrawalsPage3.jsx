...
export default function WithdrawalsPage3() {
  ...
  // คำนวณยอดรวม
  const totalRequested = Object.values(selectedBooks).reduce((sum, qty) => sum + (qty || 0), 0)
  const totalApproved = totalRequested // ในกรณีนี้ approved = requested
                  ...
                  <div className="border rounded-lg overflow-hidden">
                    ...
                    <div className="bg-gray-50 px-4 py-3 border-t">
                      <p className="text-sm text-gray-600">
                        ...
                        ({totalRequested} เล่ม) จากทั้งหมด {availableBooks.length} รายการ
                      </p>
                    </div>
                  </div>
                ) : (
