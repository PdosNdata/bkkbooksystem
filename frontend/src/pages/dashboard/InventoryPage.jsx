    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border dark:border-gray-700 p-5 flex items-center gap-4">
          ...
          <div><p className="text-sm text-gray-500 dark:text-gray-400">มีสต็อก</p><p className="text-2xl font-bold dark:text-white">{items.filter(i => (i.inventory?.[0]?.stock_quantity || 0) > 0).length}</p></div>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-xl border dark:border-gray-700 p-5 flex items-center gap-4">
